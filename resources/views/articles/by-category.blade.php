...
@section('title')
   ...
   <title>Knowledge Articles - {{ $articles[0] -> category -> name }}</title>
...
<div class="container">
  <h2 class="articles-heading" >Knowledge Articles Currently Has [ {{ $articles -> count() }} ] Articles In [ {{ $articles[0] -> category -> name }} ] Category</h2>
